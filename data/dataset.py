...
# extract small/big trainval annofiles and update id txt files before running
class LargeImageDataset:
    def __init__(self, opt):
        self.opt = opt
        self.db = VOCBboxDataset(opt.voc_data_dir, split='trainval_big_64', big_obj=True)
        self.tsf = Transform(opt.min_size, opt.max_size)
...
# test on small oryginal voc pascal objects
class SmallImageTestDataset:
